...
// format compatible to lddld/lddlwallet logs. This function is meant to be
...
// with the lddld/lddlwallet logs.
...
// legenddigitaliton app data dir and sends to the console when debug == true.
  ...
  const logger = new (winston.Logger)({
    transports: [
      new (winston.transports.File)({
        json: false,
        filename: path.join(app.getPath("userData"), "legenddigitaliton.log"),
