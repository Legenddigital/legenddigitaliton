...
const Page6 = StandardPage(
  "lifecycle-06",
  <T id="tutorial.ticketLifecycle.page6" m={`You should now understand a bit better the lifecycle of a ticket, so start staking your Legenddigital and participate on the community!
`}/>);
