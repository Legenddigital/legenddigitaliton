...
const messages = defineMessages({
  step0Title: {
    ...
    defaultMessage: "What is the Legenddigital Blockchain?",
  },
  step0TextBoldp1: {
    id: "tutorial.step.0.text.bold.p1",
    defaultMessage: "The blockchain is the heart of Legenddigital, "
  },
  step0Textp1: {
    id: "tutorial.step.0.text.p1",
    defaultMessage: " where all activity that takes place is stored. It is like a global, decentralised spreadsheet or ledger that records all the activity that happens when Legenddigital funds are transferred, keeping track of how many tokens are sent, and what the balance of every account is.",
  },
  step0Textp2: {
  ...
  step0Textp3: {
    ...
    defaultMessage: "Legenddigital uses an innovative hybrid proof-of-work (PoW) proof-of-stake (PoS) for validating the transactions, keeping the network secure and making decisions on the consensus rules.",
  },
  step0Textp4: {
    id: "tutorial.step.0.text.p4",
    defaultMessage: "In return for participation, miners (PoW) and stakers (PoS) are rewarded with newly generated Legenddigital tokens.",
  },
  step1Title: {
  ...
  step1Textp1: {
    ...
    defaultMessage: "It can be used to send and receive Legenddigital funds, and acts as a personal ledger of transactions.",
  },
  step1Textp2: {
  ...
  step2Textp3: {
    ...
    defaultMessage: "If the wallet encryption passphrase is forgotten or the wallet is destroyed (e.g. computer breaks), the seed can be used to recover the wallet. Same seed can also be used to export your wallet to other Legenddigital wallet clients.",
  },
  step2Textp4: {
  ...
  step3Textp1: {
    ...
    defaultMessage: "Participation in staking (PoS) requires only existing Legenddigital funds."
  },
  step3TextLightp1: {
  ...
  step3Textp3: {
    ...
    defaultMessage: "Changes are inevitable for all digital currencies, whether deciding on development matters or resolving unexpected problems. Legenddigital’s innovative governance system is built into the blockchain. This allows for seamless adaption to changes while keeping the existing blockchain ecosystem safe. The same tickets are also used as voting power when deciding on consensus changes.",
  },
  step3Textp4: {
    id: "tutorial.step.3.text.p4",
    defaultMessage: "Staking encourages long term investment in Legenddigital by giving the stakeholders decision-making power in projects governance as well rewarding them for participation."
  },
  step4Title: {
