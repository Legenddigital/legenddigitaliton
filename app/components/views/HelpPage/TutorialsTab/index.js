...
export const TutorialsTabHeader = () =>
  <DescriptionHeader
    description={<T id="help.description.tutorials" m="Learn about the various aspects of the Legenddigital network." />}
  />;

export const TutorialsTab = () => (
  <div className="overview-no-tickets">
    {/* <Link to="/mytickets/purchase" className="purchaseTickets">
      <T id="home.noTickets.purchase" m="Stake Your Idle LDDL and Earn Rewards" /> →
    </Link> */}
