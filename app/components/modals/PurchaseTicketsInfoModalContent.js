...
export default () => (
  <Aux>
    <p className="info-modal-column">
      ...
      <span className="info-modal-row">
        <span className="info-modal-row-label highlight-blue"><T id="tickets.info.ticketFee.header" m="Ticket fee (LDDL/kB)" /></span>
      ...
      <span className="info-modal-row">
        <span className="info-modal-row-label highlight-blue"><T id="tickets.info.txFee.header" m="Tx fee (LDDL/kB)" /></span>
      ...
      <span className="info-modal-row">
        ...
        <span className="info-modal-row-text"><T id="tickets.info.votingAddress.message" m="The Legenddigital address that will do the voting." /></span>
      </span>
      <span className="info-modal-row">
