...
export const checkDecreditonVersion = () => (dispatch, getState) =>{
  ...
  const releaseApiURL = "https://api.github.com/repos/legenddigital/legenddigitaliton/releases";
  axios.get(releaseApiURL, { timeout: 5000 })
    ...
    .catch(function (error) {
      console.log("Unable to check latest legenddigitaliton release version.", error);
    });
};
